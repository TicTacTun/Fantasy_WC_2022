                ...
                <div class="col-md-12">
                    <div class="main">    
                        <ul>
                            ...
                            <li class="active"><a href="admin_fixture.php">Players</a></li>
                            <li><a href="#">Points</a></li>
                        </ul>
                    </div>
                    <div class="mt-5 mb-3 clearfix" style="margin-top: 15%;">
                        <h2 class="pull-center" style="color:#fff;">Fixtures of Qatar World Cup 2022</h2>
                        <br>
                        <a href="adding_fixture.php" class="btn btn-success pull-right" style="color:#fff;"><i class="fa fa-plus"></i> Add New Fixtures</a>
                    </div>
                    <?php
                    // Include config file
