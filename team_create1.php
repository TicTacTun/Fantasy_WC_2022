...
<body>
    <div class='bg'>
        ...
        <div class="column1">
            <h2 style='font-family: "Audiowide", sans-serif'>Forward</h2>
        ...
        <div class="column2">
            <h2 style='font-family: "Audiowide", sans-serif'>MidFielder</h2>
            <table class = 'table table-striped'>
                <thead class='p-3 mb-2 bg-dark text-white'>
                    <tr>
                        <th >Country</th>
        ...
        <div class="column3">
            <h2 style='font-family: "Audiowide", sans-serif'>Defender</h2>
            <table class = 'table table-striped'>
        ...
        <div class="column4">
            <h2 style='font-family: "Audiowide", sans-serif'>Goalkeeper</h2>
            <table class = 'table table-striped'>
                <thead class= 'class="p-3 mb-2 bg-dark text-white'>
                    <tr>
                        <th >Country</th>
